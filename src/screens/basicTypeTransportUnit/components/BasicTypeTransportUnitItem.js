...
const BasicTypeTransportUnitItem = (props) => {
  ...
  const onPress = (row) => {
    history.push(`/basicTypeTransportUnit/update/${row._id}`);
  };
...
export default connect(mapStateToProps, null)(BasicTypeTransportUnitItem);
